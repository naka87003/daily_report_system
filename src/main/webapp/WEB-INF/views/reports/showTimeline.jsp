...
<c:set var="commShowTimeline"
    value="${ForwardConst.CMD_SHOWTIMELINE.getValue()}" />
            ...
            <tbody>
                ...
                <c:forEach var="report" items="${reports}" varStatus="status">
                    ...
                    <tr class="row${status.count % 2}">
                        ...
                        <td class="report_likes"><c:out value="${report.likeCount}" /></td>
        ...
        <div id="pagination">
            ...
            <c:forEach var="i" begin="1"
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <a
                            href="<c:url value='?action=${actRep}&command=${commShowTimeline}&page=${i}' />"><c:out
                                value="${i}" /></a>&nbsp;
                    </c:otherwise>
                </c:choose>
            </c:forEach>

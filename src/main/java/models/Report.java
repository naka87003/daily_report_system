...
@NamedQueries({
        ...
        @NamedQuery(name = JpaConst.Q_REP_GET_ALL_FOLLOWING, query = JpaConst.Q_REP_GET_ALL_FOLLOWING_DEF),
        @NamedQuery(name = JpaConst.Q_REP_COUNT_ALL_FOLLOWING, query = JpaConst.Q_REP_COUNT_ALL_FOLLOWING_DEF),
})

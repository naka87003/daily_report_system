...
<c:set var="commShowTimeline" value="${ForwardConst.CMD_SHOWTIMELINE.getValue()}" />
...
<body>
    <div id="wrapper">
        <div id="header">
            <div id="header_menu">
                ...
                <c:if test="${sessionScope.login_employee != null}">
                    ...
                    <a href="<c:url value='?action=${actRep}&command=${commShowTimeline}' />">タイムライン</a>&nbsp;
                </c:if>
            </div>
            <c:if test="${sessionScope.login_employee != null}">
        ...
        <div id="footer">by Takayoshi Naka</div>
    </div>
</body>
</html>